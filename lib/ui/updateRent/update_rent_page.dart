...
class UpdateRentPage extends StatefulWidget {
  UpdateRentPage({required this.rent, super.key});

  Rent rent;
  @override
  State<UpdateRentPage> createState() => UpdateRentPageState();
}

class UpdateRentPageState extends State<UpdateRentPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Editar aluguel", style: TextStyle(color: appColors.white)),
        leading: IconButton(
